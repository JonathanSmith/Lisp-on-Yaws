...
OpCase(allocate_heap_tIt):
    ...
    PreFetch(2, next);
    tmp_packed1 = Arg(0);
    AllocateHeap(tb(tmp_packed1&BEAM_LOOSE_MASK), Arg(1), tb((tmp_packed1>>BEAM_LOOSE_SHIFT)));
    NextPF(2, next);
    }
...
OpCase(allocate_heap_zero_tIt):
    ...
    PreFetch(2, next);
    tmp_packed1 = Arg(0);
    AllocateHeapZero(tb(tmp_packed1&BEAM_LOOSE_MASK), Arg(1), tb((tmp_packed1>>BEAM_LOOSE_SHIFT)));
    NextPF(2, next);
    }
...
OpCase(is_nonempty_list_allocate_fxIt):
    ...
    PreFetch(3, next);
    tmp_packed1 = Arg(1);
    IsNonemptyListAllocate(xb(tmp_packed1&BEAM_LOOSE_MASK), Arg(2), tb((tmp_packed1>>BEAM_LOOSE_SHIFT)), ClauseFail());
    NextPF(3, next);
    }
...
OpCase(move2_xxxx):
    ...
    tmp_packed1 = Arg(0);
    tmp_packed2 = Arg(1);
    Move2(xb(tmp_packed1&BEAM_LOOSE_MASK), xb((tmp_packed1>>BEAM_LOOSE_SHIFT)), xb(tmp_packed2&BEAM_LOOSE_MASK), xb((tmp_packed2>>BEAM_LOOSE_SHIFT)));
    NextPF(2, next);
    }
...
OpCase(test_heap_1_put_list_Iy):
    ...
    BeamInstr* next;
    PreFetch(2, next);
    TestHeapPutList(Arg(0), yb(Arg(1)));
    NextPF(2, next);
    }
