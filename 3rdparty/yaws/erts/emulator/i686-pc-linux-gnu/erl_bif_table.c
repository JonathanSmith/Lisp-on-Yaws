...
BifEntry bif_table[] = {
  ...
  {am_hipe_bifs, am_make_fe, 3, hipe_bifs_make_fe_3, wrap_hipe_bifs_make_fe_3},
  ...
  {am_hipe_bifs, am_show_message_area, 0, hipe_bifs_show_message_area_0, wrap_hipe_bifs_show_message_area_0},
};
